...
public class AdminServletIntegrationTest {
	  ...
	  private static final String BASE_URL = "http://localhost:8080/careerconnect/"; // Adjust the URL as needed
	    ...
	    @Test
	    public void testGetListOfEmployer() throws IOException {
	        // ... (Send an HTTP POST request to the server and get the response)
	        HttpGet httpGet = new HttpGet(BASE_URL + "admin/listOfEmployer");
	    ...
	    @Test
	    public void testGetListOfStudent() throws IOException {
	        // ... (Send an HTTP POST request to the server and get the response)
	        HttpGet httpGet = new HttpGet(BASE_URL + "admin/listOfStudent");
	        // Set the request entity, headers, etc., if needed
	        HttpResponse response = httpClient.execute(httpGet);
